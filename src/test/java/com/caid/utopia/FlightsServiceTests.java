...
public class FlightsServiceTests extends UtopiaadminApplicationTests {
	...
	public void flightInsertionTest() throws Exception {
		String uri = "/flights/insert";
		
		Flights flight = new Flights();
		Airports airportIdDeparture = new Airports();
		...
		flight.setAirportIdDeparture(airportIdDeparture);
		Airports airportIdArrival = new Airports();
		...
		flight.setAirportIdArrival(airportIdArrival);
		flight.setAirportIdDeparture(airportIdDeparture);
	...
	@Test
	@Transactional
	public void insertFlightBadArgumentTest() throws Exception {
		//airportIdDeparture (which is a required field) removed in this test case)
		String uri = "/flights/insert";
