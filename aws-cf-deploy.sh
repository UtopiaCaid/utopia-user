...
SubnetID=$UTOPIA_PRIVATE_SUBNET_1 TargetGroupArnDev=$TARGETGROUP_UTOPIA_USER_DEV_ARN \
TargetGroupArnProd=$TARGETGROUP_UTOPIA_USER_PROD_ARN VpcId=$UTOPIA_PUBLIC_VPC_ID \
